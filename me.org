...
Each section should contain it's own section based on the keybindings,
sometimes I don't care because its more efficient, but the outline
should be roughly followed.
